...
#line hidden
        ...
        [Xunit.InlineDataAttribute("Alex", "McCain", "1", "15", "1", new string[0])]
        [Xunit.InlineDataAttribute("Mary", "Jones", "100", "43", "1", new string[0])]
        [Xunit.InlineDataAttribute("The", "Emperor", "1", "42", "1", new string[0])]
        [Xunit.InlineDataAttribute("Cole", "Stevens", "42", "41", "1", new string[0])]
